...
| GitHub stars | 399 |
| GitHub forks | 63 |
| Installer/server downloads | 1,312 |
| Download delta | +4 |
| npm downloads, last week | 238 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-07-24T06:05:11.153Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
