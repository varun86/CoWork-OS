...
| GitHub stars | 388 |
| GitHub forks | 62 |
| Installer/server downloads | 1,258 |
| Download delta | +4 |
| npm downloads, last week | 205 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-07-17T05:56:34.954Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
