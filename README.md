...
| GitHub stars | 382 |
| GitHub forks | 59 |
| Installer/server downloads | 1,229 |
| Download delta | +6 |
| npm downloads, last week | 176 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-07-12T06:13:38.033Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
