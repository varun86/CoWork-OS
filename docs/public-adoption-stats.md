...
Generated at: 2026-07-12T06:13:38.033Z
...
| Installer/server downloads, lifetime | 1,229 |
...
|---|---|---|---:|---:|
| v0.5.49 | CoWork-OS-0.5.49-arm64-mac.zip | macos | 21 | +3 |
| v0.5.49 | CoWork-OS-0.5.49-arm64.dmg | macos | 49 | +2 |
| v0.5.49 | cowork-os-server-linux-x64-v0.5.49.tar.gz | server | 10 | +0 |
| v0.5.49 | CoWork-OS-Setup-0.5.49.exe | windows | 117 | +0 |
...
| v0.5.45 | cowork-os-server-linux-x64-v0.5.45.tar.gz | server | 7 | +1 |
