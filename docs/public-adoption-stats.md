...
Generated at: 2026-07-08T06:07:58.741Z
...
| Installer/server downloads, lifetime | 1,188 |
...
| v0.5.49 | CoWork-OS-0.5.49-arm64.dmg | macos | 41 | +2 |
| v0.5.49 | cowork-os-server-linux-x64-v0.5.49.tar.gz | server | 7 | +0 |
| v0.5.49 | CoWork-OS-Setup-0.5.49.exe | windows | 107 | +1 |
...
| v0.5.45 | CoWork-OS-Setup-0.5.45.exe | windows | 36 | +1 |
